        ...
        <div className="row">
			...
			<br/><div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<div className="repair text-center"><b>Security</b></div>
				...
				<div className="col-lg-4 col-md-4 col-sm-4  text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/shield.png" height="100rem" width="100rem" className="img-responsive images_padding" alt='Renovation'/>
					<div className="repair text-center"><b>HomeCare Solution</b></div>
					<div className="maintenance text-center">A home care solution provides comprehensive support and services to individuals</div>
					</div>
					</Link>
				</div>
			</div>
			<br/><div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center"  data-aos="fade-right" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/curtains.png" height="100rem" width="100rem" className="img-responsive images_padding" alt='Catering Solution'/>
					<div className="repair text-center"><b>Event Organization</b></div>
				...
				<div className="col-lg-4 col-md-4 col-sm-4  text-center"  data-aos="fade-up" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/vechile.png" height="100rem" width="100rem" className="img-responsive images_padding" alt='Washing'/>
					<div className="repair text-center"><b>vehicle Maintenance</b></div>
            ...
            <br/><div className="row">
				...
				<Link to="/Solar" className='Link' >
					...
					<div className="repair text-center"><b>Solar</b></div>
