    ...
    <div className="container ">
        ...
        <div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center"  data-aos="fade-right" data-aos-duration="2000">
					...
					<img src="/images/beautty.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Maintenance'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center"  data-aos="fade-down" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/repairing.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Maintenance'/>
				...
				<div className="col-lg-4  col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/home shift.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Shifting'/>
			...
			<br/><div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center"  data-aos="fade-right" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/pest cont.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Pest Control'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center"  data-aos="fade-down" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/clean.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Cleaning'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4  text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/renovation.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Renovation'/>
			...
			<br/><div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center"  data-aos="fade-right" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/catering.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Catering Solution'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4  text-center"  data-aos="fade-up" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/car.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Washing'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/doctor.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Clinical'/>
            ...
            <br/><div className="row">
				...
				<Link to="/Solar" className='Link' >
					<div className="p_10 text-center ">
					<img src="/images/solar.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Solar Panel'/>
                ...
                <div className="col-lg-4 col-md-4 col-sm-4 text-center"  data-aos="fade-up" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/garden.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Gardening'/>
                ...
                <div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<div className="p_10 text-center ">
					<img src="/images/security.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='Home Security'/>
