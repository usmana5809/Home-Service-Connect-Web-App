      ...
      <div className="container">
        <div className="row">
          <div className="col-md-7">
            ...
            <p>
              In the world of AuraUserve, we've crafted a space where excellence in services and heartfelt care come together to reshape
              ...
              enriched quality of life. Welcome to a transformative experience where your well-being is not just a consideration but our primary focus.
            </p>
          </div>
          <div className='col-md-5'>
            <img className='img-fluid rounded' src="/images/about.png" alt="Main" />
          </div>
        </div>
        <div className="row">
