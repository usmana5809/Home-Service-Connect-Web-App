	  ...
	  <br/>
		...
		<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<img src="/images/home-automation.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/smart-home.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4  col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/access-control.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
			...
			<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/cctv.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/notification.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4  col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/fire-alarm.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
