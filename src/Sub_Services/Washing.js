	  ...
	  <br/>
		...
		<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<img src="/images/car-wash.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/washing-machine.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4  col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/win.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
			...
			<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/gutter.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/tiles.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4  col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/solar.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
