	  ...
	  <br/>
		...
		<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					...
					<img src="/images/healthcare.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/telemedicine.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4  col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/lungs.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
			...
			<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/vaccine.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/psychology.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4  col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/test.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
			...
			<div className="row">
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/pharmacy.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4 col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/medicine.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
				...
				<div className="col-lg-4  col-md-4 col-sm-4 text-center" data-aos="fade-left" data-aos-duration="2000">
					<div className="p_10 text-center ">
					<img src="/images/protection.png" height="100rem" width="100rem" className="img-responsiv images_padding" alt='beautsalon'/>
